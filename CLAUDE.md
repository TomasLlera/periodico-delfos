...
- `src/lib/` — supabase/, tiptap/, social/, inngest/, seo.ts, formato.ts, y la
  lógica pura de cada página con sus tests: partido.ts, temporada.ts,
  plantel.ts, jugadora.ts, portada.ts, busqueda.ts, paginacion.ts
